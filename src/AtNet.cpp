             ...
             case ATNET_ADVISOR:
                {
                   ...
                   switch (Art)
                   {
                      ...
                      case 0:
                         ...
                         {
                            if (Generic1>=14) qPlayer.Messages.AddMessage (BERATERTYP_INFO, bprintf (StandardTexte.GetS (TOKEN_ADVICE, 9001), qFromPlayer.NameX.c_str(), qFromPlayer.AirlineX.c_str()));
                            if (Generic1>=7 && Generic1<14) qPlayer.Messages.AddMessage (BERATERTYP_INFO, bprintf (StandardTexte.GetS (TOKEN_ADVICE, 9002), qFromPlayer.NameX.c_str(), qFromPlayer.AirlineX.c_str(), (LPCTSTR)Cities[TafelData.City[Generic1-7].ZettelId].Name));
                         }
                         break;
                      ...
                      case 1:
                         if (qPlayer.HasBerater (BERATERTYP_INFO))
                         {
                            qPlayer.Messages.AddMessage (BERATERTYP_INFO, bprintf (StandardTexte.GetS (TOKEN_ADVICE, 9000), qFromPlayer.NameX.c_str(), qFromPlayer.AirlineX.c_str(), Sim.UsedPlanes[0x1000000+Generic1].CalculatePrice()));
                         }
                         break;
                      ...
                      case 3:
                         if (qPlayer.HasBerater (BERATERTYP_INFO))
                         {
                            qPlayer.Messages.AddMessage (BERATERTYP_INFO, bprintf (StandardTexte.GetS (TOKEN_ADVICE, 9004), qFromPlayer.NameX.c_str(), qFromPlayer.AirlineX.c_str(), Generic1));
                         }
                         break;
                      ...
                      case 4:
                         if (qPlayer.HasBerater (BERATERTYP_INFO))
                         {
                             qPlayer.Messages.AddMessage (BERATERTYP_INFO, bprintf (StandardTexte.GetS (TOKEN_ADVICE, 9005), qFromPlayer.NameX.c_str(), qFromPlayer.AirlineX.c_str(), Generic1));
                         }
                         break;
                   }
                }
