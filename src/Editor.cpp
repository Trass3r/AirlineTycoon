 ...
 */
   ...
   if (Plane.Parts.GetNumUsed()>0)
   {
      for (long cx=-1; cx<=1; cx++)
         for (long cy=-1; cy<=1; cy++)
         {
            ...
            if (speed>0)     RoomBm.PrintAt (bprintf(StandardTexte.GetS (TOKEN_MISC, 8207), (LPCTSTR)(CString)Einheiten[EINH_KMH].bString(speed)), FontSmallBlack, TEC_FONT_LEFT, 480+cx, 20+75+cy, 640+cx, 200+cy);
            ...
            //if (verbrauch2>0) RoomBm.PrintAt (bprintf("Verbrauch: %li l/100/100", verbrauch2), FontSmallBlack, TEC_FONT_LEFT, 480, 20+75+15, 640, 200);
            RoomBm.PrintAt (bprintf(StandardTexte.GetS (TOKEN_MISC, 8203), (LPCTSTR)(CString)Einheiten[EINH_DM].bString(cost)), FontSmallBlack, TEC_FONT_LEFT, 480+cx, 20+100+15+15+cy, 640+cx, 200+cy);
         }
   }
   ...
   if (Plane.Parts.GetNumUsed()>0)
   {
      ...
      if (speed>0)     RoomBm.PrintAt (bprintf(StandardTexte.GetS (TOKEN_MISC, 8207), (LPCTSTR)(CString)Einheiten[EINH_KMH].bString(speed)), FontSmallBlack, TEC_FONT_LEFT, 480, 20+75, 640, 200);
      if (tank>0)      RoomBm.PrintAt (CString(StandardTexte.GetS (TOKEN_PLANE, 1008))+": "+(CString)Einheiten[EINH_L].bString (tank), FontSmallBlack, TEC_FONT_LEFT, 480, 20+75+15, 640, 200);
      if (reichw>0)    RoomBm.PrintAt (CString(StandardTexte.GetS (TOKEN_PLANE, 1001))+": "+(CString)Einheiten[EINH_KM].bString (reichw), FontSmallBlack, TEC_FONT_LEFT, 480, 20+75+30, 640, 200);
      //if (verbrauch2>0) RoomBm.PrintAt (bprintf("Verbrauch: %li l/100/100", verbrauch2), FontSmallBlack, TEC_FONT_LEFT, 480, 20+75+15, 640, 200);
      RoomBm.PrintAt (bprintf(StandardTexte.GetS (TOKEN_MISC, 8203), (LPCTSTR)(CString)Einheiten[EINH_DM].bString(cost)), FontSmallBlack, TEC_FONT_LEFT, 480, 20+100+15+15, 640, 200);
